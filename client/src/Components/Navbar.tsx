    ...
    return (
        <>
            <nav className="flex items-center justify-between flex-wrap bg-blue-500 p-6">
                ...
                <div className="inline-block lg:hidden sm:mb-0">
                ...
                <div className={`w-full block flex-grow justify-end lg:flex lg:items-center lg:w-auto ${isMenuOpen ? 'block' : 'hidden'}`}>
                    ...
                    <DarkModeSwitch className="mr-0 sm:inline-block sm:mr-4" id="theme-switch" onChange={toggleDarkMode} checked={isDarkMode === false ? true : false} size={30} />
                </div>
            </nav>
            <hr />
            <ToastContainer />
